...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  choice_screen.ChoiceScreen = class ChoiceScreen extends framework.StatelessWidget {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[21] || CT.C21, backgroundColor: colors.Colors.green}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([new elevated_button.ElevatedButton.new({onPressed: dart.fn(() => navigator.Navigator.pop(core.String, context, "Да"), T.VoidTovoid()), child: C[22] || CT.C22, style: elevated_button.ElevatedButton.styleFrom({backgroundColor: colors.Colors.green})}), new elevated_button.ElevatedButton.new({onPressed: dart.fn(() => navigator.Navigator.pop(core.String, context, "Нет"), T.VoidTovoid()), child: C[23] || CT.C23, style: elevated_button.ElevatedButton.styleFrom({backgroundColor: colors.Colors.green})})])})})});
    }
  };
